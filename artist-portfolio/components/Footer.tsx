...
const socialLinks = [
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        <path d="M22 7h-7V5h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.782 5.375 4.426.078.506.109 1.188.095 2.14H15.97c.13 3.211 3.483 3.312 4.588 2.029H23.7zm-7.249-4h4.562c-.055-1.669-1.219-2.938-2.228-2.938-1.349 0-2.189 1.07-2.334 2.938zM8.061 10.469c0-2.857-2.183-4.469-5.061-4.469H0v12h3.525c3.154 0 5.364-1.73 5.536-5.016v-2.515zm-2.25 2.344c0 1.924-1.109 2.937-2.561 2.937H2.25v-7.5h1c1.451 0 2.561 1.013 2.561 2.937v1.626z"/>
      </svg>
    ),
  },
  {
